...
void setCal(){
  ...
  calData = bno.setCalvalMRL(128);
  
  calData = bno.setCalvalMRM(3);
  
  calData = bno.setCalvalAOXL(0);
  
  calData = bno.setCalvalAOXM(0);
  
  calData = bno.setCalvalAOYL(208);
  
  calData = bno.setCalvalAOYM(255);
  
  calData = bno.setCalvalAOZL(233);
 
  calData = bno.setCalvalAOZM(255);
  
  calData = bno.setCalvalMOXL(171);
  
  calData = bno.setCalvalMOXM(0);
  
  calData = bno.setCalvalMOYL(33);
 
  calData = bno.setCalvalMOYM(0);
 
  calData = bno.setCalvalMOZL(130);
  
  calData = bno.setCalvalMOZM(0);
  
  calData = bno.setCalvalGOXL(252);
  
  calData = bno.setCalvalGOXM(255);
  
  calData = bno.setCalvalGOYL(0);
  
  calData = bno.setCalvalGOYM(0);
